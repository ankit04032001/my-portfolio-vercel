export const projectsData = [
    {
        id: 1,
        name: 'Customer Movers Platform',
        description: "Accomplished: Automated order creation and address validation workflows.\n\nAs measured by: Reduced processing from multi-day to same-day.\nEliminated fifteen hours of weekly manual support work.\n\nBy doing: Built four Spring Boot microservices on Kubernetes.\nImplemented OAuth2, JWT, RBAC defense-in-depth security layers.\n\nResult: Removed three manual handoffs across teams completely.",
        tools: ['Java', 'Spring Boot', 'GCP Kubernetes', 'Apigee', 'Spring Security', 'OAuth2', 'JWT', 'REST API', 'Microservices'],
    ...
    {
        id: 4,
        name: 'Enterprise Order Tracking Dashboard',
        description: "Accomplished: Built Lightning Web Component order tracking dashboard.\n\nAs measured by: Serves 5000+ enterprise accounts with visibility.\nMigrated Zuora billing from legacy to modern API.\n\nBy doing: Implemented REST API integration and responsive design.\nBuilt client-side caching for optimal performance and reliability.\n\nResult: Eliminated recurring billing errors impacting customers completely.",
        tools: ['Salesforce', 'Lightning Web Components', 'Apex', 'REST API', 'Zuora', 'JavaScript', 'SOQL'],
